...
<Callout type="important">
  These are my personal recommendations based on my experience as a professional 3D technician, middle / high school instructor, designer, and maker.</Callout>
...
<Steps>
### Quality of Life
-The majority of the functions setup and calibration of the printer is automated increasing print quality reliability and ease of use.
> including: bed leveling, pressure advance, flow rate, resonance compensation, motor noise cancellation, acceleration.

### Integrated slicer
- Bambu Studio is an open source slicer with well tuned printing profiles for all the bambu printers.
...
<Callout type="important">
  remote connection and monitoring is available with the Bambu Studio mobile app and from within the slicer. All printers require wifi internet access for these features to functions</Callout>
