...
<Tabs.Tab key="Voron Design">
Voron is not a company, but a community-driven open-source project that develops CoreXY printer designs like the Voron 2.4, Trident, and V0.

Users source their own components and build printers from scratch or kits. The designs emphasize precision, speed, and high-quality parts.
</Tabs.Tab>

<Tabs.Tab key="LDO Motors">
LDO Motors is a supplier known for producing high-quality Voron printer kits. They provide complete packages including CNC-machined parts, electronics, and detailed manuals.

LDO kits are considered some of the most complete and reliable options for DIY CoreXY builds.
</Tabs.Tab>
