...
<Callout tpye="info">
All 3d Printed models only retain ~ 40% strength in the Z axis due to layer adheasion
</Callout>
...
<Callout type="important">
The thermistor is the most important safety feature of an FFF 3D printer. All modern 3D printers have thermal runaway protections that will alert and shut down the printer. Thermal runaway occurs when a Nozzle continues to receive power without raising the 
